...
\begin{figure}
    ...
    %\begin{minipage}{0.45\textwidth}
        %\centering
        \includegraphics[width=320pt, height=250pt]{image-grid}
...
\end{figure}
    %\begin{minipage}{0.45\textwidth}
       % \centering
  \begin{figure}
        \includegraphics[width=350pt, height=250pt]{priors}
...
\begin{figure}
        \includegraphics[width=320pt, height=280pt]{biplot.pdf}
...
\begin{figure}
    %\begin{minipage}{0.45\textwidth}
       \includegraphics[width=350pt, height=220pt]{affect-prior.pdf}
