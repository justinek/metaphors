...
var numTrials = allTrialOrders.length / 4;
...
var trial;
var numComplete = 0;
var shuffledSpeakers = shuffle(allSpeakers);
var speaker;
var trialIndex;
var question;
var answer;
...
var experiment = {
    ...
    att1s: new Array(numTrials),
    att2s: new Array(numTrials),
    att3s: new Array(numTrials),
  ...
  next: function() {
    if (numComplete > 0) {
      ...
      experiment.att1s[currentTrialNum] = document.attributes.att1.value;
      experiment.att2s[currentTrialNum] = document.attributes.att2.value;
      experiment.att3s[currentTrialNum] = document.attributes.att3.value;
