...
[
[
{"item": "giraffe", "dimension": "height", "det": "a", "question": "How likely do you think the giraffe is the following heights?", "unit": "feet", "bins": [1, 4, 4.5, 5, 5.5, 6, 6.5, 7, 15]},
{"item": "penguin", "dimension": "height", "det": "a",  "question": "How likely do you think the penguin is the following heights?", "unit": "feet", "bins": [1, 4, 4.5, 5, 5.5, 6, 6.5, 7, 15]},
{"item": "cheetah", "dimension": "speed", "det": "a", "question": "How likely do you think the cheetah can run at the following speeds at its fastest?", "unit": "miles per hour", "bins": [1, 5, 6, 7, 8, 9, 10, 20, 60]},
{"item": "turtle", "dimension": "speed", "det": "a", "question": "How likely do you think the turtle can run at the following speeds at its fastest?", "unit": "miles per hour", "bins": [1, 5, 6, 7, 8, 9, 10, 20, 60]},
...
{"item": "man", "dimension": "height", "det": "a", "question": "How likely do you think the man is the following heights?", "unit": "feet", "bins": [1, 4, 4.5, 5, 5.5, 6, 6.5, 7, 15]},
{"item": "man", "dimension": "speed", "det": "a", "question": "How likely do you think the man can run at the following speeds at his fastest?", "unit": "miles per hour", "bins": [1, 5, 6, 7, 8, 9, 10, 20, 60]},
...
{"item": "woman", "dimension": "height", "det": "a", "question": "How likely do you think the woman is the following heights?", "unit": "feet", "bins": [1, 4, 4.5, 5, 5.5, 6, 6.5, 7, 15]},
{"item": "woman", "dimension": "speed", "det": "a", "question": "How likely do you think the woman can run at the following speeds at her fastest?", "unit": "miles per hour", "bins": [1, 5, 6, 7, 8, 9, 10, 20, 60]},
...
var experiment = {
  ...
  next: function() {
    if (numComplete > 0) {
      ...
      experiment.bins0[currentTrialNum] = 0 + "-" + trial.bins[0];
      experiment.bins1[currentTrialNum] = trial.bins[0] + "-" + trial.bins[1];
      experiment.bins2[currentTrialNum] = trial.bins[1] + "-" + trial.bins[2];
      experiment.bins3[currentTrialNum] = trial.bins[2] + "-" + trial.bins[3];
      experiment.bins4[currentTrialNum] = trial.bins[3] + "-" + trial.bins[4];
      experiment.bins5[currentTrialNum] = trial.bins[4] + "-" + trial.bins[5];
      experiment.bins6[currentTrialNum] = trial.bins[5] + "-" + trial.bins[6];
      experiment.bins7[currentTrialNum] = trial.bins[6] + "-" + trial.bins[7];
      experiment.bins8[currentTrialNum] = trial.bins[7] + "-" + trial.bins[8];
