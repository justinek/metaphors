...
relevant_fields = ["workerid", "Answer.gender", "Answer.age", "Answer.income", "Answer.nativeLanguage", "Answer.orders", "Answer.animalIDs", "Answer.animals", "Answer.QUDs", "Answer.conditions", "Answer.isMetaphors", "Answer.ratings"]
relevant_indices = []
