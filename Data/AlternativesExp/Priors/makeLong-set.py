...
itemFields = ["Answer.categoryIDs", "Answer.orders", "Answer.animals", "Answer.set1probs_animals", "Answer.set2probs_animals", "Answer.set3probs_animals", "Answer.set4probs_animals", "Answer.set5probs_animals", "Answer.set6probs_animals", "Answer.set7probs_animals", "Answer.set8probs_animals"]
...
for l in f:
    ...
    if firstline == 0:
        ...
        print "workerid,gender,age,income,categoryID,order,animal,1,2,3,4,5,6,7,8"
    else:
        toks = l.split("\t")
