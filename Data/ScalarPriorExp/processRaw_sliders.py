...
relevant_fields = ["workerid", "Answer.gender", "Answer.age", "Answer.income", "Answer.nativeLanguage", "Answer.orders", "Answer.items", "Answer.dimensions","Answer.bins0", "Answer.bins1", "Answer.bins2", "Answer.bins3", "Answer.bins4", "Answer.bins5", "Answer.bins6", "Answer.bins7", "Answer.bins8", "Answer.bins9", "Answer.priors0", "Answer.priors1", "Answer.priors2", "Answer.priors3", "Answer.priors4", "Answer.priors5", "Answer.priors6", "Answer.priors7", "Answer.priors8", "Answer.priors9"]
