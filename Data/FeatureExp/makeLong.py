...
itemFields = ["Answer.orders", "Answer.categoryIDs", "Answer.animals", "Answer.adjectives"]

print "workerid,gender,language,income,age,order,categoryID,animal,adjective"
